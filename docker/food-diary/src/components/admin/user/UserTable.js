...
import {Button, Form, Icon, Input, Table, Container} from 'semantic-ui-react'
...
class UserTable extends Component {
    ...
    handleGetUsers = () => {
        ...
        const url = '/api/v1/user/show/all'
    ...
    handleSearchUser = () => {
        ...
        const url = username ? `/api/v1/user/show/all?data=${username}` : '/api/v1/user/show/all'
    ...
    prevPage = () => {
        ...
        let url = `/api/v1/user/show/all?page=${this.state.prev}&size=${this.state.size}`
    ...
    nextPage = () => {
        const Auth = this.context
        const user = Auth.getUser()
        let url = `/api/v1/user/show/all?page=${this.state.next}&size=${this.state.size}`
                ...
                <Table compact striped selectable textAlign={"center"}>
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.HeaderCell width={4}>Роль</Table.HeaderCell>
                        </Table.Row>
                    </Table.Header>
                    <Table.Body>
                        {this.initUserList()}
