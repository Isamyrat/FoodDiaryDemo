...
class FoodDiaryTable extends Component {
    ...
    handleGetFoodDiary = () => {
        ...
        const url = `/api/v1/food/diary/show/all/by-user/${this.state.userId}`
    ...
    prevPage = () => {
        ...
        let url = `/api/v1/food/diary/show/all/by-user/${this.state.userId}?page=${this.state.prev}&size=${this.state.size}`
    ...
    nextPage = () => {
        const Auth = this.context
        const user = Auth.getUser()
        let url = `/api/v1/food/diary/show/all/by-user/${this.state.userId}?page=${this.state.next}&size=${this.state.size}`
