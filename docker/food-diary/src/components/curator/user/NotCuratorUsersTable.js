...
class NotCuratorUsersTable extends Component {
    ...
    handleGetUsers = () => {
        ...
        const url = '/api/v1/user/show/all/not/curator/users'
    ...
    handleSearchUser = () => {
        ...
        const url = username ? `/api/v1/user/show/all/not/curator/users?data=${username}` : '/api/v1/user/show/all/not/curator/users'
    ...
    prevPage = () => {
        ...
        let url = `/api/v1/user/show/all/not/curator/users?page=${this.state.prev}&size=${this.state.size}`
    ...
    nextPage = () => {
        const Auth = this.context
        const user = Auth.getUser()
        let url = `/api/v1/user/show/all/not/curator/users?page=${this.state.next}&size=${this.state.size}`
    ...
    handleAddUser = (userId) => {
        ...
        orderApi.addUserToCurator(user, userId)
            .then(() => {
                this.handleGetUsers()
            })
            .catch(error => {
...
export default NotCuratorUsersTable